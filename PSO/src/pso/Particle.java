...
public class Particle {
    ...
    public int getSize() {
        return _position.size();// the size of the list
    }

    public void setPosition(int index, double value) {
        this._position.set(index, value);//here just put a position into the arraylist which hold the positions of this particular particle
    }

    public double getPosition(int index) {
        return _position.get(index);//get the position of this particular particle
    }

    public List<Double> getPosition() {
        return _position; // return all the position that this particle already visited
    }

    public void setVelocity(int index, double value) {
        _velocity.set(index, value); //set the velocity hold in the list for this particle
    }
